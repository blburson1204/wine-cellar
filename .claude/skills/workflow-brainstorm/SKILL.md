...
description:
  ...
  refines rough ideas into fully-formed designs through collaborative
  questioning, alternative exploration, and incremental validation. Don't use
  during clear 'mechanical' processes
---
...
- Use `/plan NNN-feature` to create the implementation plan in specs/
